...
GAMES = [  # Week 3 — order = kickoff order; the marquee game (Kiffin in Oxford) closes
    dict(
        ...
        decides=["The prep flagged this as the Big 12's first great litmus test: Houston is the sleeper, Tech the defending champ",
                 ...
                 "The line has moved six points toward Houston since August (−13.5 → −7.5); the machine hasn't moved"],
    ...
    dict(
        ...
        machine="South Carolina –5", market="–3.5", value="1.4 to South Carolina — no play · MONSTER UNDER 59.5",
        wp=("SCAR", 63, "MSST", 37),
    ...
    dict(
        ...
        decides=["Two first-year coaches in the SEC's most underrated game: Sumrall (Tulane to the CFP) vs Golesh (USF 114th to 30th in SP+)",
                 "The machine takes the home dog: Auburn 52.5% vs a market 44% — the line has moved four points to Florida since August",
    ...
    dict(
        ...
        machine="LSU –5", market="–3", value="2.2 to LSU — quibble · MONSTER UNDER 58.5",
        wp=("LSU", 62, "MISS", 38),
...
SHORT = {
    "Houston at Texas Tech": dict(
        ...
        decides=["The Big 12's first litmus test", "Fritz's year three", "Hammond after the scare in Corvallis", "Six points to Houston since August"],
    ...
    "Mississippi State at South Carolina": dict(
        ...
        honesty="1.4 to South Carolina — no play · Monster Under 59.5",
    ...
    "LSU at Ole Miss": dict(
        ...
        honesty="2.2 to LSU — quibble · Monster Under 58.5",
