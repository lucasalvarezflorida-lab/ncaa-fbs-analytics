...
GAMES = [
    ...
    dict(
        ...
        decides=[
            ...
            "SMU kept the roster (57% back, 15 adds) but lost BOTH coordinators to committee troikas; FSU kept Norvell but rents portal QBs a third time",
        ...
        keys_a=["Prove the troika can call it — tempo and spacing from drive one, no committee hesitation on fourth downs",
                "Protect the new quarterback from FSU's top-10 portal front — line play is the one place SMU is a tier below",
